...
2. 사용자 초대 및 초대 수락
   ...
   - 초대하기
     ...
     - 상대방에게 묻고 싶은 질문을 선택하고, 답변을 작성합니다.
     - 초대링크를 생성 후 카카오톡으로 공유하거나, 링크를 복사하여 상대방에게 전달합니다.

         <img src='docs/send-invitation.gif' width='30%'>
   ...
   - 초대 수락하기
     ...
     - 로그인에 성공하면 로그인 전에 작성한 답변을 등록할 수 있으며, 커플이 맺어짐과 동시에 서로의 답변을 확인할 수 있습니다.
        ...
        <img src='docs/accept-invitation.gif' width='30%'>
